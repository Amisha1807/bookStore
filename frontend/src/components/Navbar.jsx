...
const Navbar = () => {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-800 rounded-box w-52">
      {navItems}
      </ul>
    </div>
  ...
  <input type="text" className="grow outline-none dark:bg-inherit dark:text-white" placeholder="Search" />
